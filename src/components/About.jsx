...
const About = () => {
  const points = [
    "Specialized in crafting exceptional mobile apps for both iOS and Android platforms",
    "Technology Consultant intern at PwC, India",
    "B.E. 2023 Grad @ Jadavpur University, Kolkata, India",
    "Leetcode: Top 5% (Rating: 1840)",
    "Codechef: 4 Star (Rating; 1858)",
  ];
  ...
  return (
    <div className="flex flex-col text-left max-w-[2000px] xl:px-10 min-h-screen justify-center mx-auto items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:justify-evenly p-10">
        ...
        <motion.div
          className="flex flex-col max-w-[800px] items-evenly justify-center col-span-1 pt-2"
        ...
        >
          ...
          {points.map((point, index) => (
            <li className="mb-8 xl:text-2xl lg:text-xl md:text-lg text-md font-serif font-light text-gray-300">
              {point}
            </li>
          ))}
          {/* </ul> */}
