...
const WorkExperience = () => {
  ...
  return (
    <div className="min-h-screen mx-auto md:px-10 px-4 flex justify-center items-center flex-col">
      <motion.div>
        <p
          className={`uppercase text-center text-sm tracking-[6px] text-gray-400 animate-fade-up`}
        >
...
const ExperienceCard = ({ experience }) => {
  return (
    ...
    >
      <div>
        <h3 className="text-[#F2A2E8] text-[24px] font-bold">
          {experience.title}
        </h3>
        <p
