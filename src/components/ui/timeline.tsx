  ...
  return (
    <div className="w-full bg-background font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl md:text-6xl font-semibold mb-4 text-foreground max-w-4xl">
          {title}
        </h2>
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-4xl mb-4 text-left font-semibold text-muted-foreground">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
